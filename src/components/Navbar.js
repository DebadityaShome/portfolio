        ...
        <header className="bg-red-600">
            <div className="container mx-auto flex justify-between">
                <nav className="flex">
                    ...
                    className="inflex-flex items-center py-6 px-3 mr-4 text-red-100 hover:text-green-800 text-4xl font-bold"
                    >
                        Debaditya
                    </NavLink>
                    ...
                    <NavLink to="/publication" className="inline-flex items-center py-3 px-3 my-6 rounded text-red-200 hover:text-green-800"
                    activeClassName="text-red-100 bg-red-700"
                    >
                        Publications
                    </NavLink>
                ...
                <div className="inline-flex py-3 px-3 my-6">
                    <SocialIcon url="https://www.linkedin.com/in/debaditya-shome-355546186/" className="mr-4" target="_blank" fgColor="#fff" style={{ height: 35, width: 35 }}/>
